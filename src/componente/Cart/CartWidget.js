        ...
        <label tabIndex={0} className="btn btn-ghost btn-circle m-2">
          <div className="indicator">
            ...
            <span className="badge badge-sm indicator-item">{products.length}</span>
             ...
             {products.map( (data) => {
              return (
                <li><a>{data.name} {data.price}</a></li>  )  }) }
            { products.length === 0 ?
         <li>
              <div tabIndex={0} className="mt-3   w-50 bg-base-100 shadow">
              ...
              :
              <li>
              <div tabIndex={0} className="mt-3 card card-compact  w-50 bg-base-100 shadow">
                <div className="card-body">
                  <div className="card-actions">
